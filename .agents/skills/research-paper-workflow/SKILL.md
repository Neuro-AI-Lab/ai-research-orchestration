...
Before each editing session, obtain explicit authority to pull if remote freshness must be established.
Never resolve a merge conflict by discarding remote work. Never push to Overleaf, save references, or
change external state without user authority. Before submission, record
