...
Usage: python3 .claude/scripts/sweep_summary.py experiments/EXP-NNN

Reads experiments/EXP-NNN/runs/*/status.json (written by run_with_status.sh) and, when present,
