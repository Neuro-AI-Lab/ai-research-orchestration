...
def record_turn_stop(payload, root, continuity_current):
    """Record a turn boundary; only the launcher can record actual process exit."""
    ...
    try:
        ...
        append_event('turn_stopped', {
            ...
            'runtime_source': 'native_nonblocking_turn_hook',
        })
        purge_pending()
    except Exception:
        return
...
def main():
    ...
    record_turn_stop(payload, root, handoff_is_current(root))
    return 0
