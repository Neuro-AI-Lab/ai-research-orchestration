...
literature MCP server (.codex/scripts/literature_mcp.py).

Usage:
  python3 .codex/scripts/lit_search.py <source> "<query>" [--limit N] [--venue "NeurIPS"]
                                        [--year 2020-2026] [--json]
...
# Set LIT_CONTACT_EMAIL (e.g. in .codex/settings.local.json env) to join OpenAlex's polite pool
