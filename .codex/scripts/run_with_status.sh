...
#
# Usage:  .codex/scripts/run_with_status.sh EXP-NNN -- <command...>
# Writes: ${EXPERIMENTS_DIR:-experiments/codex}/EXP-NNN/status.json  (state machine:
#         launched -> running -> completed|failed, with pid/heartbeat/exit_code)
#         ${EXPERIMENTS_DIR:-experiments/codex}/EXP-NNN/run.log      (all output, appended)
#
...
RUN_DIR="${EXPERIMENTS_DIR:-experiments/codex}/$EXP_ID"
mkdir -p "$RUN_DIR"
